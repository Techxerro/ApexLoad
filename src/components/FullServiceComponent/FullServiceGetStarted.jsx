            ...
            <>
              <div className="grid md:grid-cols-2 gap-10 lg:gap-0 lg:flex justify-between 3xl:justify-around mb-10">
                {slides.slice(0, 3).map((slide, index) => (
                  <div
                    key={index}
                    className="bg-[#292929] h-[480px] lg:w-[300px] xl:h-[500px] xl:w-[380px] 2xl:h-[450px] 2xl:w-[460px] 3xl:h-[500px] 3xl:w-[550px]"
                  >
                    <div className="h-1/2">
                      <img src={slide.img} alt="" className="h-full w-full" />
                    </div>
...
export default FullServiceGetStarted